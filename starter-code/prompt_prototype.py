...
# Task 1: Điều chỉnh prompt System Instruction
SYSTEM_PROMPT = """
...
- Instead, you must immediately recommend or trigger a Mobile Charging Vehicle (xe cứu hộ sạc pin lưu động) dispatch in structured format:
{"action": "dispatch_mobile_charger", "reason": "<explain_why>"}
accompanied by driver instructions to park safely.
"""


# Task 2: Cập nhật hàm evaluate_prompt
    ...
    for i, test in enumerate(ADVERSARIAL_TESTS, start=1):
        ...
        try:
            ...
            if i == 2:
                ...
                has_tag = output.startswith("[DRAFT_ONLY]") or "[DRAFT_ONLY]" in output
                if has_tag:
